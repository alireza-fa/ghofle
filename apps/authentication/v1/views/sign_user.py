...
from apps.authentication.v1.services.sign_user import login_by_password, register_user, login_by_phone_number, \
    verify_sign_user
from apps.authentication.v1.serializers.sign_user import (UserLoginByPasswordSerializer, AuthenticatedResponseSerializer, RegisterSerializer,
